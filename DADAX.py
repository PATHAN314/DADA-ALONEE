...
def main_apv():
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+923038289017?text=' + tks)
...
\_______/ \__|  \__|\_______/ \__|  \__| 
 ...
 [$]*****************************************************[$]
   ...
   \x1b[1;92m║ AUTHOR    : DADAX_X_ALONE🍷😳      ║
   \x1b[1;92m║ GITHUB    : git.me/PATHAN ║
   \x1b[1;92m║ FACEBOOK  : DADAX\_____😘😈😘   ║
   \x1b[1;92m║ Group     : BROKEN🤒 ALONE😳 ║
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back DADAX-PRO Tools")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[DADAX]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
